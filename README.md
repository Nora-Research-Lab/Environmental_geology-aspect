# Aspect - Environmental Geology Suite
...
## Overview
This repository hosts the standardized **Aspect** dataset, a key component of the Environmental Geology data framework maintained by **NORA Research Lab**. The data is provided as Cloud-Optimized GeoTIFFs (COG) to support high-performance spatial analysis and GeoAI workflows.
